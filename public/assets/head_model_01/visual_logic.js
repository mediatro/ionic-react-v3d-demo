 ...
 * Sun Jan 02 2022 22:08:14 GMT-0800 (Pacific Standard Time)
...
updateTextObj('Textobject', String(toFixedPoint(getObjTransform('mechanism_chin-ball', false, 'position', 'y'), 4)));

('Example Puzzle for dealing with the 2 nose shape morphs. This concept will be used for any other morph, too.' + '\n' +
'' + '\n' +
'');

registerOnClick('mechanism_slider_nose_tip', false, false, [0,1,2], function() {
  playSound(loadMedia_WebAudio('nose-intro.mp3'), false);
  registerOnDrag('mechanism_slider_nose_tip', false, [0,1,2], function() {}, function() {
    dragMove('mechanism_slider_nose_tip', 'Z', 'hMLVlh7oW+fUDP^m)i=@', 'vhR1:r-It[1DCZ3s-uRB');
    current_nl = toFixedPoint(getObjTransform('mechanism_slider_nose_tip', false, 'position', 'z') + -0.195, 3);
    if (current_nl > 0) {
      setMorphFactor('ZBrushPolyMesh3D.001', 'Nose short', current_nl * 25);
    } else {
      setMorphFactor('ZBrushPolyMesh3D.001', 'Nose long', current_nl * -25);
    }
    updateTextObj('Textobject', current_nl);
  }, function() {}, 'vhR1:r-It[1DCZ3s-uRB');
}, function() {});

registerOnClick('mechanism_chin-ball', false, false, [0,1,2], function() {
  registerOnDrag('mechanism_chin-ball', false, [0,1,2], function() {}, function() {
    dragMove('mechanism_chin-ball', 'Y', 'xc_9fS]d9V`onJ-|kJw#', '%HK!TJzT2g5#Pdep%Adc');
    current_cb = toFixedPoint(getObjTransform('mechanism_chin-ball', false, 'position', 'y') + 0.14, 3);
    setMorphFactor('ZBrushPolyMesh3D.001', 'Chin Ball', current_cb * -33);
    updateTextObj('Textobject', current_cb);
  }, function() {}, '%HK!TJzT2g5#Pdep%Adc');
}, function() {});
